...
//    }
    ...
    public MyDialog2 setTitle(String title) {
        this.title = title;
        return this;
    }

    public MyDialog2 setMessage(String message) {
        this.message = message;
        return this;
    }

    public MyDialog2 setCancel(String cancel, MyOnCancelListener listener) {
        this.cancel = cancel;
        this.cancelListener = listener;
        return this;
    }

    public MyDialog2 setConfirm(String confirm, MyOnConfirmListener listener) {
    ...
    public interface MyOnCancelListener{
        void onCancel(MyDialog2 dialog);
    }

    @FunctionalInterface
    public interface MyOnConfirmListener{
        void onConfirm(MyDialog2 dialog);
    }
}
