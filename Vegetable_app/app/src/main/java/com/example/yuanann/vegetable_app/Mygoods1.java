...
public class Mygoods1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //声明数据
        int[] imageA = {R.drawable.xhs4, R.drawable.hlb2, R.drawable.xc4, R.drawable.lj2,
                R.drawable.ym3, R.drawable.dg4, R.drawable.td2, R.drawable.xhs3,};
...
//                R.drawable.w9,R.drawable.w11,R.drawable.w10,R.drawable.w12,};
        ...
        double[] descC = {1.3, 4.2, 5.4, 3.5, 2.4, 5.8,1.5,4.9};
        String[] descA = { "新鲜西红柿", "新鲜胡萝卜", "新鲜香菜", "新鲜辣椒","新鲜玉米",  "新鲜冬瓜", "新鲜土豆", "新鲜西红柿"};
...
//        h4.setBackgroundResource(imageB[num]);
        ...
        f1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(Mygoods1.this, Home.class);
        ...
        gm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(Mygoods1.this, Pay.class);
...
//                db.delete("cart", "cart_id=?", new String[]{"11"});
        ...
        gwc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                long i = -1;
                //创建数据库
                CartDBOpenHelper dbOpenHelper = new CartDBOpenHelper(Mygoods1.this,1);
                SQLiteDatabase db = dbOpenHelper.getWritableDatabase();
                //商品数量
...
//                int goods_num = 0;
                ...
                if (i != -1)
                    Toast.makeText(Mygoods1.this, descA[num] + "加入购物车成功！", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(Mygoods1.this, "加入购物车失败！", Toast.LENGTH_SHORT).show();
                dbOpenHelper.close();
        ...
        cd1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(Mygoods1.this, Mygoods.class);
    ...
    private int isExist(int g_id){
        dbOpenHelper = new CartDBOpenHelper(Mygoods1.this,1);
