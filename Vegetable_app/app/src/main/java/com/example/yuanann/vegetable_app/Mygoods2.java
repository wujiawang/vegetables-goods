...
public class Mygoods2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] imageA = {R.drawable.ym3, R.drawable.hlb3, R.drawable.bc2, R.drawable.lj3,
                R.drawable.xc3, R.drawable.dg4, R.drawable.lj1, R.drawable.gm4,};
...
//                R.drawable.w9,R.drawable.w11,R.drawable.w10,R.drawable.w12,};
        int[] id = {23, 24,25,26,27,28,29,30};
        String[] descB = {"顺丰发货 多种维C", "绿色生态 清香美味", "有机健康 新鲜必买", "包邮 最快次日到达", "味道深厚 色香味甜", "香甜脆爽 好吃又健康", "顺丰发货 多种维C", "绿色生态 清香美味"};
        double[] descC = {2.00, 3.00, 1.50, 2.60, 3.60, 6.50,2.50,3.00};
        String[] descA = {"新鲜玉米", "新鲜胡萝卜", "新鲜白菜", "新鲜辣椒", "新鲜香菜", "新鲜冬瓜", "新鲜辣椒", "新鲜蘑菇"};
        ...
        goods.add(new Goods(30, R.drawable.gm4, "新鲜蘑菇", "香甜脆爽 好吃又健康", 3.00, 12, "京东超市"));
...
//        h4.setBackgroundResource(imageB[num]);
        ...
        gm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(Mygoods2.this, Pay.class);
...
//                db.delete("cart", "cart_id=?", new String[]{"11"});
        ...
        gwc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                long i = -1;
                //创建数据库
                CartDBOpenHelper dbOpenHelper = new CartDBOpenHelper(Mygoods2.this,1);
                SQLiteDatabase db = dbOpenHelper.getWritableDatabase();
                //商品数量
...
//                    CartDBOpenHelper helper = new CartDBOpenHelper(this,this."jdshop");
...
//                    db.insert("user", null, contentvalues);
                ...
                if (i != -1)
                    Toast.makeText(Mygoods2.this, descA[num] + "加入购物车成功！", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(Mygoods2.this, "加入购物车失败！", Toast.LENGTH_SHORT).show();
                dbOpenHelper.close();
        ...
        cd1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(Mygoods2.this, Mygoods.class);
    ...
    private int isExist(int g_id){
        dbOpenHelper = new CartDBOpenHelper(Mygoods2.this,1);
